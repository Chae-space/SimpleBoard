	...
	<!-- Footer ================================================== -->
		...
		<div class="row">
			<table class="table  table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<c:forEach var="board" items="${myBoard_list}">
						<c:if test="${sessionScope.nickname==board.writer}">
							<tr>	
								<td>${board.writer }</td>
					...
					<a href="${pageContext.request.contextPath}/Board/boardList" class="nino-btn" style="background: #95e1d3;" onclick="return LoginCheck(${id})">전체 리스트</a>
			</table>
		</div>
	</div>
